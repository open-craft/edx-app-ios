...
3. In a separate dir, create your whitelist configuration file, e.g. ``../my-app-config/whitelist.yaml``
...
6. Run the `whitelabel.py` script to apply your whitelabel changes to the current branch. ::
    ...
    python script/whitelabel.py --config-file=../my-app-config/whitelist.yaml -v
