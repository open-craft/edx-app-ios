...
# List of revisions to patch into the source. Omit to apply no patches.
# Patch revisions should be named in order of desired application, and
# be available in the cloned project repo.
patches:
    - 2579a37b5c8d011c487ec756afbf6e6dcb974044
    - 38f238a8c69bc66401e75841f63527a8cb2fd754
